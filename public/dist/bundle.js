...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	    ...
	    var scroll = __webpack_require__(32)(window);
	...
	module.exports = function($scope, $articles, $location) {
	    ...
	    this.date = function(data) {
	        data.articles.forEach(function(item, index) {
	            item.date = item.date.substring(0,
	                    item.date.indexOf('T')) + ' ' +
	                item.date.substring(item.date.indexOf('T') + 1,
	                    item.date.indexOf('.'));
	        });
	    };
